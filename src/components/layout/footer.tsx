        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <div className="space-y-3">
            <Link href="/" className="flex items-center space-x-2">
              <div className="relative h-8 w-8 overflow-hidden rounded-full bg-gradient-to-r from-cyan-500 to-blue-600">
                <Image
                  src="/syntra-logo.png"
                  alt="Syntra Logo"
                  width={32}
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-3">
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/products/ehr" className="text-sm text-slate-600 hover:text-primary">
                    Electronic Health Records
                  </Link>
                </li>
                <li>
                  <Link href="/products/coding" className="text-sm text-slate-600 hover:text-primary">
                    AI Medical Coding
                  </Link>
                </li>
                <li>
                  <Link href="/products/authorization" className="text-sm text-slate-600 hover:text-primary">
                    Prior Auth Automation
                  </Link>
                </li>
                <li>
                  <Link href="/products/telehealth" className="text-sm text-slate-600 hover:text-primary">
                    Telehealth Platform
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/careers" className="text-sm text-slate-600 hover:text-primary">
                    Careers
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/hipaa" className="text-sm text-slate-600 hover:text-primary">
                    HIPAA Compliance
                  </Link>
                </li>
                <li>
                  <Link href="/security" className="text-sm text-slate-600 hover:text-primary">
                    Security
                  </Link>
                </li>
              </ul>
